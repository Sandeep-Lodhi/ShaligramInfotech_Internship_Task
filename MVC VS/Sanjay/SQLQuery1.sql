create database SP355_SanjayMvcTest

--use SP355_SanjayMvcTest
...
create proc SP_GetQuestionsAndAnswers
as
begin

select q.id as QId, q.title as QTitle ,A.id as AId, A.isCorrect as AIsCorrect, A.title as ATitle  from Questions Q inner join Answers A on Q.id = A.questionId

end 

exec  SP_GetQuestionsAndAnswers
